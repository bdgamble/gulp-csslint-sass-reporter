/*
 * gulp-csslint-scss-reporter (https://github.com/bdgamble/gulp-csslint-scss-reporter)
 *
 * Copyright 2016 Bryan Gamble
 *
 * Licensed under MIT (https://github.com/bdgamble/gulp-csslint-scss-reporter/blob/master/LICENSE)
 */
...
var pluginName = 'gulp-csslint-scss-reporter';

module.exports = function scssReporter(importsFilter) {
  var allErrors = [];
  ...
  var reportErrors = function reportErrors(file, enc, callback) {
    ...
    var origFilePath = path.resolve(gutil.replaceExtension(file.path, '.scss'));
